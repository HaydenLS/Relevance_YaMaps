...
### Откройте страницу **Metrics** слева (в меню Pages), чтобы:
- загрузить файлы (`батчи`) полученные в `Batch Run`
- получить метрики и матрицу ошибок
- поулчить итоговый полный файл
