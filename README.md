...
На данный момент на `eval` датасете с использованием всех меток `(0.0, 0.1, 1.0)` Accuracy состовляет *0.62*
Без использования метки `0.1` - Accuracy (на данный момент не оценено)
